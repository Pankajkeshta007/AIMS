...
<div class="container">
        ...
        <div class="button-container">
            <a class="button" href="StudentAdd.jsp">ADD FACULTY</a>
            
            <a class="button" href="StudentViewServlet">VIEW FACULTY</a>
            <a class="button" href="StudentUpdate.jsp">UPDATE FACULTY</a>
            <a class="button" href="StudentDelete.jsp">DELETE FACULTY</a>
