...
<body>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-4 col-md-4 text-center">
                            <a href="https://smartcookie.in/Clogin/login/student" class=" " role="button"><img src="https://smartcookie.in/image/student250.png" alt="" width="200" height="200"></a>
                            <br/>
                             <span class="sf"><h4>Student Login</h4></span>           
                </div> 
                <div class="col-xl-4 col-md-4 text-center">
                            <a href="https://smartcookie.in/Clogin/login/teacher" class=" " role="button"><img src="https://smartcookie.in/image/teacher250.png" alt=""  width="200" height="200"></a>
                            <br/>
                            <span><h4>Faculty Login</h4></span>
                </div>
                 ...
                 <div class="col-xl-4 col-md-4 text-center">
                            <form method="POST" name='loginform' id='loginform'>
                             ...
                             <span class="sf"><h4>Admin Login</h4></span>           
                </div>
    ...
    <div class="container">
        <div class =" row justify-content-center pt-5 ">
            <a href="https://smartcookie.in/Assets/documents/Frequestly_Asked_Questions_AICTE_20201230.pdf" target="_blank"><center><img src="https://smartcookie.in/Assets/image/faq.png" class="rounded mx-4 shadow-lg p-3 bg-white rounded"></center>
               <div class="card-body">
                  <center><h5 class="card-title">FAQ</h5></center>
               </div>   
            </a>
           
            <a href="https://smartcookie.in/AICTE-360degreefeedback/Upcoming-Events"><center><img src="https://smartcookie.in/Assets/image/event.png" class="rounded mx-4 shadow-lg p-3  bg-white rounded"></center>
               <div class="card-body">
